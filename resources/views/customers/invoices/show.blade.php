    ...
    <section class="invoice">
        ...
        <div class="box-footer row no-print">
            <div class="col-md-10">
                ...
                <a href="{{ url('customers/invoices/' . $invoice->id . '/pdf') }}" class="btn btn-default" data-toggle="tooltip"
            ...
            <div class="col-md-2 no-padding-right">
                ...
                @if ($payment_methods)
                {!! Form::select('payment_method', $payment_methods, null, array_merge(['id' => 'payment-method',
                'class' => 'form-control', 'placeholder' => trans('general.form.select.field', ['field' =>
