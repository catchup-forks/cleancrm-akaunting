        ...
        <div class="col-md-12">
            <div class="form-group required {{ $errors->has('api_token') ? 'has-error' : ''}}">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('api_token', setting('general.api_token', null), ['class' => 'form-control',
                    'required' => 'required', 'placeholder' => trans('general.form.enter', ['field' =>
                    trans('modules.api_token')])]) !!}
                </div>
