...
<span class="new-button"><a href="{{ url('expenses/payments/create') }}" class="btn btn-success btn-sm"><span class="fa fa-plus"></span>
        &nbsp;{{ trans('general.add_new') }}</a></span>
<span><a href="{{ url('common/import/expenses/payments') }}" class="btn btn-default btn-sm"><span class="fa fa-download"></span>
        &nbsp;{{ trans('import.import') }}</a></span>
@endpermission
<span><a href="{{ route('payments.export', request()->input()) }}" class="btn btn-default btn-sm"><span class="fa fa-upload"></span>
        ...
        <div class="table table-responsive">
            <table class="table table-striped table-hover" id="tbl-payments">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="{{ url('expenses/payments/' . $item->id . '/edit') }}">{{
                                Date::parse($item->paid_at)->format($date_format) }}</a></td>
                        <td class="text-right amount-space">@money($item->amount, $item->currency_code, true)</td>
                        <td class="hidden-xs">{{ !empty($item->vendor->name) ? $item->vendor->name :
                            trans('general.na') }}</td>
                        ...
                        <td class="text-center">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="{{ url('expenses/payments/' . $item->id . '/edit') }}">{{
                                            trans('general.edit') }}</a></li>
                                    @permission('create-expenses-payments')
                                    <li class="divider"></li>
                                    <li><a href="{{ url('expenses/payments/' . $item->id . '/duplicate') }}">{{
