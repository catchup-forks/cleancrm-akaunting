...
<span class="new-button"><a href="{{ url('expenses/bills/create') }}" class="btn btn-success btn-sm"><span class="fa fa-plus"></span>
        &nbsp;{{ trans('general.add_new') }}</a></span>
<span><a href="{{ url('common/import/expenses/bills') }}" class="btn btn-default btn-sm"><span class="fa fa-download"></span>
        &nbsp;{{ trans('import.import') }}</a></span>
@endpermission
<span><a href="{{ route('bills.export', request()->input()) }}" class="btn btn-default btn-sm"><span class="fa fa-upload"></span>
            ...
            <table class="table table-striped table-hover" id="tbl-bills">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="label {{ $item->status->label }}">{{ trans('bills.status.' .
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a href="{{ url('expenses/bills/' . $item->id . '/edit') }}">{{
                                            trans('general.edit') }}</a></li>
                                    <li class="divider"></li>
                                    @permission('create-expenses-bills')
                                    <li><a href="{{ url('expenses/bills/' . $item->id . '/duplicate') }}">{{
