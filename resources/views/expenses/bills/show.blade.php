            ...
            <div class="col-xs-12">
                ...
                <div class="btn-group dropup">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="{{ url('expenses/bills/' . $bill->id . '/received') }}">{{
                                trans('bills.mark_received') }}</a></li>
                        @else
                        <li><a href="javascript:void(0);" class="disabled"><span class="text-disabled">{{
                                    trans('bills.mark_received') }}</span></a></li>
                        @endif
                        @endpermission
                        <li class="divider"></li>
                        @endif
                        <li><a href="{{ url('expenses/bills/' . $bill->id . '/pdf') }}">{{ trans('bills.download_pdf')
                                }}</a></li>
                        <li class="divider"></li>
                ...
                <span class="attachment">
                    <a href="{{ url('uploads/' . $bill->attachment->id . '/download') }}">
                        <span id="download-attachment" class="text-primary">
                            <i class="fa fa-file-{{ $bill->attachment->aggregate_type }}-o"></i> {{
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('expenses/bills/' . $payment->id . '/edit') }}" class="btn btn-primary btn-xs  hidden"><i
                                    ...
                                    'onclick' => 'confirmDelete("' . '#bill-payment-' . $payment->id . '", "' .
