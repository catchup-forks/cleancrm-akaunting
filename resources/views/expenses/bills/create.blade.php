    ...
    <div class="box-body">
        ...
        <div class="form-group col-md-6 required {{ $errors->has('vendor_id') ? 'has-error' : ''}}">
            ...
            <div class="input-group">
                ...
                {!! Form::select('vendor_id', $vendors, null, array_merge(['id' => 'vendor_id', 'class' =>
                'form-control', 'placeholder' => trans('general.form.select.field', ['field' =>
