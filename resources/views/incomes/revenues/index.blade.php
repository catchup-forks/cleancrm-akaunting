...
<span class="new-button"><a href="{{ url('incomes/revenues/create') }}" class="btn btn-success btn-sm"><span class="fa fa-plus"></span>
        &nbsp;{{ trans('general.add_new') }}</a></span>
<span><a href="{{ url('common/import/incomes/revenues') }}" class="btn btn-default btn-sm"><span class="fa fa-download"></span>
        &nbsp;{{ trans('import.import') }}</a></span>
@endpermission
<span><a href="{{ route('revenues.export', request()->input()) }}" class="btn btn-default btn-sm"><span class="fa fa-upload"></span>
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <div class="pull-left">
            ...
            {!! Form::select('customer', $customers, request('customer'), ['class' => 'form-control input-filter
            input-sm']) !!}
            ...
            <table class="table table-striped table-hover" id="tbl-revenues">
                <thead>
                    <tr>
                        ...
                        <th class="col-md-3 hidden-xs">@sortablelink('customer.name', trans_choice('general.customers',
                            1))</th>
                        <th class="col-md-2 hidden-xs">@sortablelink('category.name',
                            trans_choice('general.categories', 1))</th>
                        <th class="col-md-2 hidden-xs">@sortablelink('account.name', trans_choice('general.accounts',
                            1))</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="{{ url('incomes/revenues/' . $item->id . '/edit') }}">{{
                                Date::parse($item->paid_at)->format($date_format) }}</a></td>
                        <td class="text-right amount-space">@money($item->amount, $item->currency_code, true)</td>
                        <td class="hidden-xs">{{ !empty($item->customer->name) ? $item->customer->name :
                            trans('general.na') }}</td>
                        ...
                        <td class="text-center">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="{{ url('incomes/revenues/' . $item->id . '/edit') }}">{{
                                            trans('general.edit') }}</a></li>
                                    @permission('create-incomes-revenues')
                                    <li class="divider"></li>
                                    <li><a href="{{ url('incomes/revenues/' . $item->id . '/duplicate') }}">{{
