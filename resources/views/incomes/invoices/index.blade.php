...
<span class="new-button"><a href="{{ url('incomes/invoices/create') }}" class="btn btn-success btn-sm"><span class="fa fa-plus"></span>
        &nbsp;{{ trans('general.add_new') }}</a></span>
<span><a href="{{ url('common/import/incomes/invoices') }}" class="btn btn-default btn-sm"><span class="fa fa-download"></span>
        &nbsp;{{ trans('import.import') }}</a></span>
@endpermission
<span><a href="{{ route('invoices.export', request()->input()) }}" class="btn btn-default btn-sm"><span class="fa fa-upload"></span>
            ...
            <table class="table table-striped table-hover" id="tbl-invoices">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="label {{ $item->status->label }}">{{ trans('invoices.status.' .
                                $item->status->code) }}</span></td>
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="{{ url('incomes/invoices/' . $item->id) }}">{{ trans('general.show')
                                            }}</a></li>
                                    <li><a href="{{ url('incomes/invoices/' . $item->id . '/edit') }}">{{
                                            trans('general.edit') }}</a></li>
                                    @permission('create-incomes-invoices')
                                    <li class="divider"></li>
                                    <li><a href="{{ url('incomes/invoices/' . $item->id . '/duplicate') }}">{{
