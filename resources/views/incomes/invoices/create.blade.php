    ...
    <div class="box-body">
        ...
        <div class="form-group col-md-6 required {{ $errors->has('customer_id') ? 'has-error' : ''}}">
            ...
            <div class="input-group">
                ...
                {!! Form::select('customer_id', $customers, null, array_merge(['class' => 'form-control', 'placeholder'
                => trans('general.form.select.field', ['field' => trans_choice('general.customers', 1)])])) !!}
        ...
        setting('general.default_currency')) }}
        ...
        'autocomplete' => 'off'], Date::now()->toDateString()) }}

        {{ Form::textGroup('due_at', trans('invoices.due_date'), 'calendar',['id' => 'due_at', 'class' =>
        'form-control', 'required' => 'required', 'data-inputmask' => '\'alias\': \'yyyy/mm/dd\'', 'data-mask' => '',
        'autocomplete' => 'off']) }}

        {{ Form::textGroup('invoice_number', trans('invoices.invoice_number'), 'file-text-o', ['required' =>
        'required'], $number) }}
