...
@section('new_button')
<span class="new-button"><a href="{{ url('banking/accounts/create') }}" class="btn btn-success btn-sm"><span class="fa fa-plus"></span>
            ...
            <table class="table table-striped table-hover" id="tbl-accounts">
                <thead>
                    <tr>
                        ...
                        <th class="col-md-3 text-right amount-space">@sortablelink('opening_balance',
                            trans('accounts.current_balance'))</th>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="{{ url('banking/accounts/' . $item->id . '/edit') }}">{{
                                            trans('general.edit') }}</a></li>
                                    @if ($item->enabled)
                                    <li><a href="{{ route('accounts.disable', $item->id) }}">{{
                                            trans('general.disable') }}</a></li>
                                    @else
                                    <li><a href="{{ route('accounts.enable', $item->id) }}">{{ trans('general.enable')
                                            }}</a></li>
                                    @endif
