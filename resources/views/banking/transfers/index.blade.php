...
@section('new_button')
<span class="new-button"><a href="{{ url('banking/transfers/create') }}" class="btn btn-success btn-sm"><span class="fa fa-plus"></span>
...
<div class="box box-success">
    <div class="box-header with-border">
        ...
        <div class="pull-left">
            ...
            {!! Form::select('from_account', $accounts, request('from_account'), ['class' => 'form-control input-filter
            input-sm']) !!}
            {!! Form::select('to_account', $accounts, request('to_account'), ['class' => 'form-control input-filter
            input-sm']) !!}
            ...
            <table class="table table-striped table-hover" id="tbl-transfers">
                <thead>
                    <tr>
                        ...
                        <th class="col-md-3 text-right amount-space">@sortablelink('payment.amount',
                            trans('general.amount'))</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="{{ url('banking/transfers/' . $item->id . '/edit') }}">{{
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="{{ url('banking/transfers/' . $item->id . '/edit') }}">{{
