...
@section('new_button')
<span class="new-button"><a href="{{ url('common/companies/create') }}" class="btn btn-success btn-sm"><span class="fa fa-plus"></span>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    @if ($item->enabled)
                                    <li><a href="{{ route('companies.switch', $item->id) }}">{{ trans('general.switch')
                                            }}</a></li>
                                    <li class="divider"></li>
                                    @endif
                                    <li><a href="{{ url('common/companies/' . $item->id . '/edit') }}">{{
                                            trans('general.edit') }}</a></li>
                                    @if ($item->enabled)
                                    <li><a href="{{ route('companies.disable', $item->id) }}">{{
                                            trans('general.disable') }}</a></li>
                                    @else
                                    <li><a href="{{ route('companies.enable', $item->id) }}">{{ trans('general.enable')
                                            }}</a></li>
                                    @endif
