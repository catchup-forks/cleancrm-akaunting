...
@section('new_button')
<span class="new-button"><a href="{{ url('auth/users/create') }}" class="btn btn-success btn-sm"><span class="fa fa-plus"></span>
                    ...
                    <tr>
                        <td>
                            <a href="{{ url('auth/users/' . $item->id . '/edit') }}">
                                ...
                                @else
                                @if ($item->picture)
                                <img src="{{ Storage::url($item->picture->id) }}" class="users-image" alt="{{ $item->name }}"
                                    title="{{ $item->name }}">
                                @endif
                                @endif
                                {{ $item->name }}
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="{{ url('auth/users/' . $item->id . '/edit') }}">{{
                                            trans('general.edit') }}</a></li>@if ($item->enabled)
                                    <li><a href="{{ route('users.disable', $item->id) }}">{{ trans('general.disable')
                                            }}</a></li>
                                    @else
