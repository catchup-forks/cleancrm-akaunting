    ...
    <div class="col-md-4">
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                {{ Form::textGroup('code', trans('offlinepayment::offlinepayment.code'), 'key', ['required' =>
                'required'], null, 'col-md-12') }}

                {{ Form::radioGroup('customer', trans('offlinepayment::offlinepayment.customer'), '', ['required' =>
                'required'], 0, 'col-md-12') }}

                {{ Form::textGroup('order', trans('offlinepayment::offlinepayment.order'), 'sort', [], null,
                'col-md-12') }}
                            ...
                            <tr id="method-{{ $item->code }}">
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-danger btn-xs method-delete" id="delete-{{ $item->code }}"
                                        title="{{ trans('general.delete') }}"><i class="fa fa-trash-o" aria-hidden="true"></i>
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $('#install-loading').html(
                        '<span class="install-loading-bar"><span class="install-loading-spin"><i class="fa fa-spinner fa-spin"></i></span></span>'
                    );
                    $('.install-loading-bar').css({
                        "height": $('.col-md-4.no-padding-left').height() - 23
                    });
                },
                complete: function () {
                ...
                success: function (json) {
                    ...
                    if (json['success']) {
                        $('.col-md-4.no-padding-left .box-header.with-border .box-title').html(
                            json['data']['title']);
                        ...
                        $('.col-md-4 .box-body').append(
                            '<input type="hidden" name="method" value="' + json['data']
                            ['method'] + '">');
                    }
                }
            });
